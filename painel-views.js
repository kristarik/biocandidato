...
const ICONES_MENU = {
  ...
  foguete:
    '<path fill-rule="evenodd" d="M58.4,61.5l2.7,10,6.7-6.7-1.9-7.1c-2.6,1.6-5.1,2.9-7.5,3.7h0ZM74.3,38.9c0-1.3-.5-2.5-1.5-3.5s-2.2-1.5-3.5-1.5-2.5.5-3.5,1.5c-1,1-1.5,2.2-1.5,3.5s.5,2.5,1.5,3.5,2.2,1.5,3.5,1.5,2.5-.5,3.5-1.5c1-1,1.5-2.2,1.5-3.5h0ZM74.2,34c1.3,1.3,2,3.1,2,4.9s-.7,3.5-2,4.9c-1.3,1.3-3.1,2-4.9,2s-3.5-.7-4.9-2-2-3.1-2-4.9.7-3.5,2-4.9c1.3-1.3,3.1-2,4.9-2s3.5.7,4.9,2h0ZM76.8,22.5c.3.8.7,1.6,1.2,2.4.7,1,1.5,2,2.4,3,1,1,2,1.8,3,2.4.8.5,1.6.9,2.4,1.2,1.2-3.8,1.2-6.8-.5-8.5s-4.8-1.8-8.5-.5h0ZM50.8,41.9l-7.4-2-6.7,6.7,10.3,2.8c.8-2.3,2.1-4.9,3.8-7.4h0ZM56.1,60.4l-8.5-8.5-2.8,2.8c-.1.1-.2.2-.2.4s0,.3.2.4l7.7,7.7c.1.1.2.2.4.2s.3,0,.4-.2l2.8-2.8h0ZM48.7,50.3c.8-2.4,2.2-5,4-7.7,1.9-2.9,4.3-5.9,7.2-8.7,5-5,10.4-8.7,15.1-10.7.4.9.8,1.8,1.4,2.7.7,1.1,1.6,2.3,2.7,3.3s2.2,2,3.3,2.7c.9.6,1.8,1.1,2.7,1.4-1.9,4.7-5.6,10.1-10.7,15.1-2.8,2.8-5.7,5.1-8.5,7,0,0,0,0,0,0h-.1c-2.7,1.9-5.4,3.2-7.8,4.1l-9.3-9.3h0ZM51.7,64.8c-1.9,1.7-3.9,3-6,3.9-2.2,1-4.6,1.5-7,1.5-.5,0-1-.4-1-1,0-2.4.6-4.8,1.5-7,.9-2.1,2.2-4.1,3.9-6-.2-.4-.4-.8-.4-1.3s.2-1.3.7-1.7l2.3-2.3-11.2-3c-.5-.1-.8-.7-.7-1.2,0-.2.1-.3.2-.4l8.2-8.2c.3-.3.6-.3,1-.2l8.6,2.3c1.8-2.6,4.1-5.3,6.6-7.8,5.3-5.3,11-9.2,15.9-11.2,5.2-2.1,9.7-2.1,12.2.4,2.5,2.5,2.5,7,.4,12.2-2,5-5.9,10.7-11.2,15.9-2.7,2.7-5.5,5-8.2,6.9l2.2,8.2c0,.3,0,.7-.2,1l-8.2,8.2c-.1.1-.3.2-.4.2-.5.1-1-.2-1.2-.7l-3-11.2-2,2c-.5.5-1.1.7-1.7.7s-.9-.1-1.3-.4h0ZM44.4,57.7l5.8,5.8c-1.7,1.5-3.5,2.6-5.3,3.4-1.7.7-3.5,1.2-5.3,1.3.1-1.8.6-3.6,1.3-5.3.8-1.8,1.9-3.6,3.4-5.3h0ZM29.5,51c.4-.4,1-.4,1.4,0s.4,1,0,1.4l-8.5,8.5c-.4.4-1,.4-1.4,0s-.4-1,0-1.4l8.5-8.5h0ZM17.6,62.9c.4-.4,1-.4,1.4,0s.4,1,0,1.4l-.7.7c-.4.4-1,.4-1.4,0-.4-.4-.4-1,0-1.4l.7-.7h0ZM55.2,76.7c.4-.4,1-.4,1.4,0s.4,1,0,1.4l-8.5,8.5c-.4.4-1,.4-1.4,0s-.4-1,0-1.4l8.5-8.5h0ZM43.3,88.7c.4-.4,1-.4,1.4,0s.4,1,0,1.4l-.7.7c-.4.4-1,.4-1.4,0s-.4-1,0-1.4l.7-.7h0ZM20.2,75.6l8.7-8.7c.4-.4.4-1,0-1.4s-1-.4-1.4,0l-8.7,8.7c-.4.4-.4,1,0,1.4.4.4,1,.4,1.4,0h0ZM31.9,64c-.4.4-1,.4-1.4,0s-.4-1,0-1.4l.9-.9c.4-.4,1-.4,1.4,0s.4,1,0,1.4l-.9.9h0ZM33.5,88.9l8.7-8.7c.4-.4.4-1,0-1.4s-1-.4-1.4,0l-8.7,8.7c-.4.4-.4,1,0,1.4s1,.4,1.4,0h0ZM45.2,77.2l.9-.9c.4-.4.4-1,0-1.4s-1-.4-1.4,0l-.9.9c-.4.4-.4,1,0,1.4s1,.4,1.4,0h0ZM33.1,72.7l-7.1,7.1c-.4.4-.4,1,0,1.4s1,.4,1.4,0l7.1-7.1c.4-.4.4-1,0-1.4s-1-.4-1.4,0h0ZM23,82.8c.4-.4,1-.4,1.4,0s.4,1,0,1.4l-2,2c-.4.4-1,.4-1.4,0s-.4-1,0-1.4l2-2Z"/>',
};

// O foguete veio do arquivo da marca, desenhado num quadro de 107 onde o traco
// ocupa so o miolo e fica fora do centro. A caixa aqui e recortada em cima do
// desenho para ele nascer centralizado na bolha, em vez de pequeno e torto.
const CAIXA_DO_ICONE = { foguete: '13.5 16 79 79' };

function iconeMenu(nome, tamanho = 21) {
  const caixa = CAIXA_DO_ICONE[nome] || '0 0 24 24';
  return `<svg viewBox="${caixa}" width="${tamanho}" height="${tamanho}" fill="currentColor" aria-hidden="true">${ICONES_MENU[nome]}</svg>`;
}
...
${
  ...
  <a href="/painel/turbinar" class="foguete ${aba === 'turbinar' ? 'ativa' : ''}">
    <span class="bolha">${iconeMenu('foguete', 36)}</span><span>Turbinar</span>
  </a>
